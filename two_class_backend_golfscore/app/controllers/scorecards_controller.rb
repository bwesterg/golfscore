class ScorecardsController < ApplicationController
    ...
    def update
        ...
        @scorecard.course_name = params[:course_name]
        @scorecard.tees_name = params[:tees_name]
        @scorecard.tees_yardage = params[:tees_yardage]
        ...
        @scorecard.players_attributes = players_attributes
